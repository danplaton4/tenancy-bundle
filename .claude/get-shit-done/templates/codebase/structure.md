...
- Usage: Reference from command with `@/Users/danplaton/dev/packages/[claude-code] symfony-multitenancy/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/danplaton/dev/packages/[claude-code] symfony-multitenancy/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/danplaton/dev/packages/[claude-code] symfony-multitenancy/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
