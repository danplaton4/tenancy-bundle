...
- **Global scope**: `/Users/danplaton/dev/packages/[claude-code] symfony-multitenancy/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/danplaton/dev/packages/[claude-code] symfony-multitenancy/.claude/notes/`)
...
2. Glob `/Users/danplaton/dev/packages/[claude-code] symfony-multitenancy/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/danplaton/dev/packages/[claude-code] symfony-multitenancy/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/danplaton/dev/packages/[claude-code] symfony-multitenancy/.claude/notes/` — works in any directory
