...
**In progress:** **v0.5 Operations & Scale** — production-readiness: tenant-level maintenance mode, health checks, parallel migrations, and ops docs. **All four phases shipped + verified: Phase 31 (parallel `tenancy:migrate`, ISOL-07..12) — 2026-06-26; Phase 32 (per-tenant Maintenance Mode, MAINT-01..09) — 2026-07-01; Phase 33 (Tenant Health Checks, HEALTH-01..07) — 2026-07-06; Phase 34 (ops docs DOC-21 + v0.4 carry-forward DEMO-02/GOV-02/QA-01) — 2026-07-06.** v0.5 feature-complete; ready for the v0.5 tag (run `/gsd:complete-milestone`). See [Current Milestone](#current-milestone-v05-operations--scale) below.
...
---
*Last updated: 2026-07-06 — Phase 34 (ops docs DOC-21 + carry-forward DEMO-02/GOV-02/QA-01) complete + verified (9/9 must-haves; 970 tests, PHPStan L9, cs-fixer clean; DEMO-02 smoke passed live on PHP 8.2.32; code-review's 10 doc-drift findings all fixed). **v0.5 Operations & Scale is now feature-complete** — all four phases shipped + verified: 31 (ISOL-07..12), 32 (MAINT-01..09), 33 (HEALTH-01..07), 34 (DOC-21/DEMO-02/GOV-02/QA-01). No open Active requirements. Next: cut the **v0.5 tag** via `/gsd:complete-milestone`, then scope v0.6. Baseline: v0.4.1 (tag), green CI, Symfony 8.1 supported, `composer audit` gate. Prior milestone: v0.4 Storage & Shared Entities (tags v0.4.0 / v0.4.1). Full history: `.planning/MILESTONES.md` + `.planning/milestones/v0.4-ROADMAP.md`.*
