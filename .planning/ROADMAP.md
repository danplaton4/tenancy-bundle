...
- [x] 34-03-PLAN.md — DEMO-02 examples/saas config.platform.php=8.2.99 pin + composer.lock regen (no >=8.4 deps); smoke.sh green on 8.2 via CI checkpoint (DEMO-02)
- [x] 34-04-PLAN.md — GOV-02 Nyquist advisory-only policy note in contributor-guide + Phase 31 VALIDATION.md backfill (GOV-02)
- [x] 34-05-PLAN.md — QA-01 regression tests: resync confirm-YES branch + PHPStan extension-installer auto-load contract (QA-01)
