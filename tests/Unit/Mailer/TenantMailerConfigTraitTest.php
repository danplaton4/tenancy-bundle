...
final class TenantMailerConfigTraitTest extends TestCase
{
    public function testStubReservedForWave1Implementation(): void
    {
        ...
        $this->markTestIncomplete(
            'Reserved for Wave 1 implementation of TenantMailerConfigTrait '
            .'(see .planning/phases/20-mailer-bootstrapper/20-VALIDATION.md row BOOT-04-i: '
            .'TenantMailerConfigTrait provides default impls for all 3 methods)'
        );
    }
}
