...
final class TenantAwareTransportsDecoratorTest extends TestCase
{
    public function testStubReservedForWave1Implementation(): void
    {
        ...
        $this->markTestIncomplete(
            'Reserved for Wave 1 implementation of TenantAwareTransportsDecorator '
            .'(see .planning/phases/20-mailer-bootstrapper/20-VALIDATION.md row BOOT-04-c: '
            .'TenantAwareTransportsDecorator routes tenant_<slug> to correct transport; no-op if context missing)'
        );
    }
}
